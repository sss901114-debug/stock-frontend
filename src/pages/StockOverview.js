        ...
        <div>
          <h2 style={{ fontSize: 24, fontWeight: 700, color: '#1a7a3a', marginBottom: 4 }}>
            ...
            {closePrice && <span style={{ fontSize: 26, color: '#8B0000', marginLeft: 48, fontWeight: 400 }}>
              <span style={{ color: '#7a9ab8', fontSize: 13, marginRight: 6 }}>收盤價</span><b style={{ color: '#ffffff', fontSize: 42, fontWeight: 600, fontFamily: "'JetBrains Mono',monospace" }}>{closePrice.close}</b>
